cask 'rubymine-eap' do
  ...
  zap delete: [
                "~/Library/Preferences/RubyMine#{version.before_comma.major_minor}",
                "~/Library/Application Support/RubyMine#{version.before_comma.major_minor}",
                "~/Library/Caches/RubyMine#{version.before_comma.major_minor}",
                "~/Library/Logs/RubyMine#{version.before_comma.major_minor}",
              ]
end
