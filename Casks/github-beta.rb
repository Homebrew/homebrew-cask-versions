cask "github-beta" do
  ...
  version "3.0.1-beta2-a184ec34"

  if Hardware::CPU.intel?
    sha256 "b3877763d79a8d945996f1e62464fd41886fbf4ab98813db60ff4bd5cbf387f7"
  else
    sha256 "08f01a61a154228764d4bee7216f762dd8cd4509449a9b5620e3e1ad5a18ff15"
  end
