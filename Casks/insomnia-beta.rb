cask "insomnia-beta" do
  ...
  livecheck do
    ...
    strategy :page_match do |page|
      ...
      update_info = Homebrew::Livecheck::Strategy.page_content("https://updates.insomnia.rest/builds/check/mac?v=#{latest_release}&app=com.insomnia.app&channel=beta")[:content]
