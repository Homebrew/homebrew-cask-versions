cask 'adobe-acrobat-pro-2017' do
  ...
  url "https://trials3.adobe.com/AdobeProducts/APRO/Acrobat_HelpX/osx10/Acrobat_#{version}_Web_WWMUI.dmg",
      user_agent: :fake,
      cookies:    { 'MM_TRIALS' => '1234' }
  name 'Adobe Acrobat Pro 2017'
  homepage "https://helpx.adobe.com/uk/download-install/kb/acrobat-#{version}-downloads.html#AcrobatPro2017"
  ...
  zap trash: [
               ...
               "/Library/Application Support/Adobe/Acrobat #{version} AMT",
               "/Library/Application Support/Adobe/Acrobat #{version} Helper Frameworks",
               ...
               "/Library/Preferences/com.adobe.acrobat.#{version}.WebResource.plist",
