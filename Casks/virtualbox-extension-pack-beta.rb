cask "virtualbox-extension-pack-beta" do
  ...
  url "https://download.virtualbox.org/virtualbox/#{version.csv.first}/Oracle_VM_VirtualBox_Extension_Pack-#{version.csv.first}-#{version.csv.second}.vbox-extpack"
  ...
  postflight do
    system_command "/usr/local/bin/VBoxManage",
                   args:  [
                     "extpack", "install",
                     "--replace", "#{staged_path}/Oracle_VM_VirtualBox_Extension_Pack-#{version.csv.first}-#{version.csv.second}.vbox-extpack"
                   ],
                   input: "y",
                   sudo:  true
  end
